import{_ as s,o as n,c as a,R as l}from"./chunks/framework.408c4d71.js";const F=JSON.parse('{"title":"6.脚本工具","description":"","frontmatter":{},"headers":[],"relativePath":"know/know/8adb.md","filePath":"know/know/8adb.md","lastUpdated":1697590654000}'),p={name:"know/know/8adb.md"},o=l(`<h1 id="_6-脚本工具" tabindex="-1">6.脚本工具 <a class="header-anchor" href="#_6-脚本工具" aria-label="Permalink to &quot;6.脚本工具&quot;">​</a></h1><nav class="table-of-contents"><ul><li><a href="#_6-2-adb">6.2 adb</a><ul><li><a href="#_6-2-1-基本操作">6.2.1 基本操作</a></li><li><a href="#_6-2-2-捕获数组">6.2.2 捕获数组</a></li></ul></li></ul></nav><h2 id="_6-2-adb" tabindex="-1">6.2 adb <a class="header-anchor" href="#_6-2-adb" aria-label="Permalink to &quot;6.2 adb&quot;">​</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">无线连接必须先有线连接</span></span>
...
<span class="line"><span style="color:#82AAFF;">echo</span><span style="color:#A6ACCD;"> $param_y2</span></span></code></pre></div>`,8),t=[o];function e(c,r,y,i,C,D){return n(),a("div",null,t)}const E=s(p,[["render",e]]);export{F as __pageData,E as default};
