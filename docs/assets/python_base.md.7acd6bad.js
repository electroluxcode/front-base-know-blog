import{_ as s,o as n,c as a,R as p}from"./chunks/framework.408c4d71.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"python/base.md","filePath":"python/base.md","lastUpdated":1692759868000}'),l={name:"python/base.md"},o=p(`<div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">1</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">去到这个网站然后下载，注意只为我安装就可以添加到环境变量</span></span>
